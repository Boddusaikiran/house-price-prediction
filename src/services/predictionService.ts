...
export function calculatePrediction(data: PredictionRequest): PredictionResult {
  ...
  // BHK premium for larger properties
  if (data.bhk >= 3) {
    pricePerSqft *= 1.1;
  }
  ...
  // Floor preference (middle to upper floors are preferred)
